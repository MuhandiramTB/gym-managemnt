...
const SecuritySection: React.FC = () => (
  <div className="space-y-6">
    <div>
      <h3 className="text-lg font-medium text-gray-200 flex items-center gap-2"><KeyIcon className="h-5 w-5 text-indigo-400" /> Change Password</h3>
    ...
    <div>
      <h3 className="text-lg font-medium text-gray-200 flex items-center gap-2"><ShieldCheckIcon className="h-5 w-5 text-indigo-400" /> Two-Factor Authentication</h3>
      <div className="mt-4 space-y-4">
